...
Creating a new layer in Exchange allows users of the `Boundless Anywhere™ <https://connect.boundlessgeo.com/docs/anywhere/1.2.1/>`_ app to create a framework for their data, and use it to add features while out in the field.

Please email contact@boundlessgeo.comfor more information on how to get Boundless Anywhere for mobile field data collection.
